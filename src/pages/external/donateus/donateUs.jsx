...
export default function DonateUs() {
  ...
  console.log(donationAmount, customAmount);
      ...
      <div className="flex flex-col md:flex-row items-center gap-8 mb-12">
        <div className="flex-1">
          ...
          <p className="text-lg text-gray-700 mb-6">
            Your donation helps us empower the next generation of environmental
            leaders. Together, we can create a sustainable future for all.
          </p>
                  ...
                  <div className="space-y-6">
                    <div className="text-center py-8">
                      ...
                      <p className="text-gray-600 mb-6">
                        Create your own fundraising campaign to support The
                        Green Team's mission. Engage your friends, family, and
                        community to make a bigger impact.
                      </p>
              ...
              <div className="space-y-4">
                <div className="bg-white p-4 rounded-lg border border-green-100">
                  ...
                  <p className="text-gray-600">
                    Educational materials for 5 students to learn about
                    sustainability
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg border border-green-100">
                  ...
                  <p className="text-gray-600">
                    Tools and seeds for a school garden project
                  </p>
                </div>
                ...
                <div className="bg-white p-4 rounded-lg border border-green-100">
                  ...
                  <p className="text-gray-600">
                    A full day workshop for 20 young environmental leaders
                  </p>
                </div>
              </div>
      ...
      <div className="mt-16 bg-green-50 rounded-xl p-8 text-center">
        <blockquote className="max-w-3xl mx-auto">
          <p className="text-xl italic text-gray-700 mb-4">
            "The Green Team's programs changed my perspective on environmental
            issues. Now I'm leading sustainability initiatives in my school and
            community!"
          </p>
          <footer className="font-medium text-green-700">
            — Maya, 16, Student Leader
          </footer>
        </blockquote>
      </div>
    </div>
