...
const SupportUs = () => {
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            ...
            {/* Hero Section */}
            <header className="text-center py-20 bg-green-500 text-white bg-[url('https://www.greenteam.org.uk/wp-content/uploads/2022/05/2021-group-image-1024x768.jpg')] bg-cover flex flex-col justify-center bg-center bg-no-repeat " style={{ width: "100vw", height: "50vh" }}>
