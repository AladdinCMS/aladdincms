...
const HomePage = () => {
    ...
    return (
        <div className="bg-gray-100 min-h-screen">
            ...
            {/* Hero Section */}
            <header className="text-center py-20 bg-green-500 text-white bg-[url('https://www.greenteam.org.uk/wp-content/uploads/2021/05/GT_Green-Explorers_20210509_AMP-8-scaled-e1637079034745.jpg')] bg-cover flex flex-col justify-center bg-center bg-no-repeat " style={{ width: "100vw", height: "60vh" }}>
